...
<html>
   <head>
      ...
      <meta name="description" content="Google Drive File Downloader ! ">
      ...
      <link rel="shortcut icon" type="image/x-icon" href="https://img.icons8.com/color-glass/144/000000/google-logo.png">
      <title>GDRIVE DDL | Discordiy</title>
...
margin: 0 auto;
   ...
   <body>
      <h1 style="color:orange; text-align:center; cursor: pointer;"><a href="https://github.com/Discordiy">GDRIVE DDL</a></h1>
      <div>
         <img class="mxl" src="https://img.icons8.com/bubbles/200/000000/google-logo.png">
      </div>
      <br><br>
      <h3 style="text-align: center; color: #FFB200; font-family: 'Balsamiq Sans', cursive; font-size: 17px;"> Enter Your G-Drive File ID Here <br>And Click On Json</h3>
      <br><br><br>
      <div>
      <center>
      <div class="bar">
      <input type="text" class="searchbar" placeholder="FILE ID (GoogleDrive)" id="q" name="q">
      <a href="https://drive.google.com"> <img class="mxp" src="https://img.icons8.com/doodle/96/000000/google-drive.png" title="Go to GDRIVE"></a>
      </div>
      <br>
      <button class="button" onClick="handleDownload('json')">JSON</button>
      <button class="button" onclick="history.go(0)">Reset</button>
      <br>
        <script>
            function handleDownload(output) {
                var id = document.querySelector("#q").value;
                if (id) window.open("/link/" + id + (output ? "?output=" + output : ""));
            }
        </script>
      <footer class="footer">
         <div class="container">
            <span class="copyright"><a style="text-decoration: none; color: #9C9AB3;" href="/">© 2022 SAKSHAM SHEKHER</a></span>
         </div>
      </footer>
   </body>
</html>`
