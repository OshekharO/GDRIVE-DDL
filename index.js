const googleDriveCtrl = async (ctx, view) => {
   ...
   if (ctx.query.output == "media") result.cookie = resp.headers["set-cookie"];
...
const joyCtrl = async (ctx) => {
   ...
   const decodeUrl = async (body) => {
      ...
      var _0x5b60 = function (_0x4d4456, _0x5a24e3) {
         ...
         if (_0x5b60["initialized"] === undefined) {
            (function () {
               ...
               _0xef6e0["atob"] ||
                  (_0xef6e0["atob"] = function (_0x4bb81e) {
                     var _0x1c1b59 = String(_0x4bb81e)["replace"](/=+$/, "");
                     for (
                        var _0x5e3437 = 0x0, _0x2da204, _0x1f23f4, _0x3f19c1 = 0x0, _0x3fb8a7 = "";
                        (_0x1f23f4 = _0x1c1b59["charAt"](_0x3f19c1++));
                        ~_0x1f23f4 && ((_0x2da204 = _0x5e3437 % 0x4 ? _0x2da204 * 0x40 + _0x1f23f4 : _0x1f23f4), _0x5e3437++ % 0x4) ? (_0x3fb8a7 += String["fromCharCode"](0xff & (_0x2da204 >> ((-0x2 * _0x5e3437) & 0x6)))) : 0x0
                     ) {
      ...
      let args = (body.match(/(?<=strencode\()[^\)]+/) || [""])[0].split(",").map((i) => i.replace(/(^"|"$)/g, ""));

      let source = strencode.apply(null, args),
         url = "";
      if (source) {
